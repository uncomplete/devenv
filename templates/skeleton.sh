...
# This is a template... use it by:
#   - Update the script_usage() function with additional usage guidance
#   - Update the parse_params() function with additional script parameters
#   - Add additional functions to implement the desired functionality
#   - Update the main() function to call your additional functions
